...
public class MenuItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String rowOne = "<p><b><u> * Menu:</u></b><br /> It is an efficient and friendly way to display multiple options, from which users can choose what they like. </p>\n" +
                "<p>\n" +
                ...
                "<br /> " +
                "<p>" +
                "<i>1. Defining a Menu in XML:</i><br />  + To define the menu, create an XML file inside your project's res/menu/ directory and build the menu with the following elements: \n" +
                "</p>" +
                "<p>" +
                "<menu><br />\n" +
        ...
        String rowThree = "<i>How to use the menu in your Activity? </i>" +
                "<br /> + To use the menu in your activity, you need to inflate the menu resource (convert the XML resource into a programmable object) using Menuinflaterinflate0. ";
        ...
        String code2 = "<?xml version=\"1.0\" encoding=\"utf-8\"?> \n" +
                ...
                "   </item>\n" +
                " </menu>\n";
        String code3 = "MenuInflater inflater = getMenuInflater();\n" +

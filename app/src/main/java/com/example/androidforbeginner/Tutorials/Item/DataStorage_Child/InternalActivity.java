...
public class InternalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String rowOne = "<b><u>Internal Storage:</u></b><br>" +
                ...
                "<br>" +
                "<b>What kind of data can be stored in Internal Storage?</b><br> The type of data involves things such as a text file, image file, video file, audio file etc. \n" +
                "<br>" +
                "<b>Where are the files stored?</b> <br>Files are stored in the directory data/date<package-name>/files folder To create and write a private file to the internal storage: \n" +
        ...
        String rowTwo = "<b>How to read data from Internal Storage?</b><br>" +
        ...
        String code2 = "FileInputStream fis = openFileInput(FILENAME); \n" +
                "int read=-1; \n" +

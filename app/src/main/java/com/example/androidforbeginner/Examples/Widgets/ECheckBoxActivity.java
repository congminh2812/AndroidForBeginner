...
public class ECheckBoxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_echeck_box);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.menu_play:
                Intent intent = new Intent(this,ECheckBoxRunActivity.class);
    ...
    public String getColumnTwoJava() {
        String columnTwo = "import android.graphics.Color;\n" +
                "import android.support.v7.app.AppCompatActivity;\n" +
                "import android.os.Bundle;\n" +
                "import android.support.v7.widget.Toolbar;\n" +
                "import android.view.MenuItem;\n" +
    ...
    public String getColumnTwoXML() {
        String columnTwo = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                ...
                "        android:text=\"Red\"\n" +
                "        android:id=\"@+id/ckb_red\"/>\n" +
                "    <CheckBox\n" +
                "        android:layout_width=\"wrap_content\"\n" +
                "        android:layout_height=\"wrap_content\"\n" +
                "        android:text=\"Green\"\n" +
                "        android:id=\"@+id/ckb_green\"/>\n" +
                "    <CheckBox\n" +
                "        android:layout_width=\"wrap_content\"\n" +
                "        android:layout_height=\"wrap_content\"\n" +
                "        android:text=\"Blue\"\n" +
                "        android:id=\"@+id/ckb_blue\"/>\n" +
                "    <Button\n" +
                "        android:layout_width=\"wrap_content\"\n" +
                "        android:layout_height=\"wrap_content\" \n" +
                "        android:text=\"Button\"\n" +

...
public class ESwitchActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.menu_play:
                Intent intent = new Intent(this,ESwitchRunActivity.class);
    ...
    public String getColumnTwoXML() {
        String columnTwo = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                ...
                "    tools:context=\".Examples.Item.ESwitchRunActivity\">\n" +
                "    <Switch\n" +

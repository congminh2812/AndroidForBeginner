...
public class ESpinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_espinner);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.menu_play:
                Intent intent = new Intent(this,ESpinnerRunActivity.class);

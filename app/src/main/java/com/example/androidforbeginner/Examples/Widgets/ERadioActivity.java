...
public class ERadioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eradio);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.menu_play:
                Intent intent = new Intent(this,ERadioRunActivity.class);
    ...
    public String getColumnTwoXML() {
        String columnTwo = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                ...
                "    tools:context=\".Examples.Item.EButtonRunActivity\">\n" +
                "\n" +
                "    <RadioGroup\n" +
                ...
                "            android:layout_height=\"wrap_content\" \n" +
                "            android:text=\"Red\"\n" +
                "            android:id=\"@+id/red__button\"\n" +
                "            />\n" +
                "        <RadioButton\n" +
                "            android:layout_width=\"wrap_content\"\n" +
                "            android:layout_height=\"wrap_content\"\n" +
                "            android:text=\"Yellow\"\n" +
                "            android:id=\"@+id/yellow__button\"\n" +
                "            />\n" +
                "        <RadioButton\n" +
                "            android:layout_width=\"wrap_content\"\n" +
                "            android:layout_height=\"wrap_content\"\n" +
                "            android:text=\"Magenta\"\n" +
                "            android:id=\"@+id/magenta__button\"\n" +
                "            />\n" +
                "        <RadioButton\n" +
                "            android:layout_width=\"wrap_content\"\n" +
                "            android:layout_height=\"wrap_content\"\n" +
                "            android:text=\"Cyan\"\n" +
                "            android:id=\"@+id/cyan__button\"\n" +
                "            />\n" +
                "    </RadioGroup>\n" +
                "</LinearLayout>";
        return columnTwo;

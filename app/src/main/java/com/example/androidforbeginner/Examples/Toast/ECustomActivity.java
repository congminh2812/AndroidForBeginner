...
public class ECustomActivity extends AppCompatActivity {
        ...
        private void addControl() {
            ...
            adapter.addFragment(new FragmentItem(),"custom_toast.xml");
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            switch (item.getItemId()) {
                case android.R.id.home:
                    ...
                    break;
                case R.id.menu_play:
                    Intent intent = new Intent(this, ECustomRunActivity.class);
        ...
        public String getColumnTwoJava() {
            String columnTwo =
                            ...
                            "        view = inflater.inflate(R.layout.custom_toast, (ViewGroup) findViewById(R.id.custom_layout));\n" +
                            "        \n" +
                            "    }\n" +
                            "\n" +

...
public class EVideoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evideo_view);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.menu_play:
                Intent intent = new Intent(this, EVideoViewRunActivity.class);
    ...
    public String getColumnTwoJava() {
        String columnTwo =
                        ...
                        "        videoView.setVideoURI(Uri.parse(\"https://www.youtube.com/watch?v=P87zkTMY0YU\"));\n" +
